...
public class Carro {
    ...
    private void validarCarro(String placa, Cor cor) {
        if (placa == null || placa.isEmpty()) {
            throw new NullPointerException("Carro precisa de uma placa");
        }
        if (cor == null) {
            throw new NullPointerException("Carro precisa de uma cor");
        }
    }
